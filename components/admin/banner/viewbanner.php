    ...
    <div class="col-md-12">
            <div class="panel-default">
                ...
                <div class="panel-body">
                     ...
                     if (is_array($getSlider)) {
                        ...
                        ?>
                          <tr>
                            ...
                            <td><a href="/account.php?page=editbanner&slider_id=<?php echo $SliderID?>"><i class="fa-solid fa-pencil search"></i></a></td>
                            <td><a href="/account.php?page=viewbanner&slider_delete_id=<?php echo $SliderID?>"><i class="fa-solid fa-trash search"></i></a></td>
                    ...
                    <a href="/account.php?page=addbanner">
